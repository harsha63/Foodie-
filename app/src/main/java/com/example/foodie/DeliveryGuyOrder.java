...
public class DeliveryGuyOrder extends AppCompatActivity {
    private static final String TAG= "Delivery ORDER";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        recyclerView = findViewById(R.id.driverOrders);
        ...
        fStore.collection("Orders").whereEqualTo("Assigned",false).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                for (DocumentSnapshot documentSnapshot : task.getResult()) {
                    orders = new Order(documentSnapshot.getString("UserID"), documentSnapshot.getString("Restaurant"), documentSnapshot.getString("UserName"),
