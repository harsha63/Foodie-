    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changePass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Delivery.this, "Changed password successfully", Toast.LENGTH_SHORT).show();
        ...
        changeName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user.put("fName",name);
                documentReference.set(user, SetOptions.merge());
                Toast.makeText(Delivery.this, "Changed Name successfully", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changePhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                documentReference.set(user, SetOptions.merge());
                Toast.makeText(Delivery.this, "Changed Phone successfully", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changeLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                documentReference.set(user, SetOptions.merge());
                Toast.makeText(Delivery.this, "Changed Location successfully " + longi+ " " + lati, Toast.LENGTH_SHORT).show();
